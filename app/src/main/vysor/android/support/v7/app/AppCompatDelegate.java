...
public abstract class AppCompatDelegate
{
    ...
    private static AppCompatDelegate create(final Context context, final Window window, final AppCompatCallback appCompatCallback) {
        ...
        if (BuildCompat.isAtLeastN()) {
            appCompatDelegateImplV9 = new AppCompatDelegateImplN(context, window, appCompatCallback);
        }
        else if (sdk_INT >= 23) {
            appCompatDelegateImplV9 = new AppCompatDelegateImplV23(context, window, appCompatCallback);
        }
        else if (sdk_INT >= 14) {
            appCompatDelegateImplV9 = new AppCompatDelegateImplV14(context, window, appCompatCallback);
        }
        else if (sdk_INT >= 11) {
            appCompatDelegateImplV9 = new AppCompatDelegateImplV11(context, window, appCompatCallback);
        }
        else {
            appCompatDelegateImplV9 = new AppCompatDelegateImplV9(context, window, appCompatCallback);
        }
        return appCompatDelegateImplV9;
    }
