...
public class TintTypedArray
{
    ...
    public ColorStateList getColorStateList(final int n) {
        ...
        ColorStateList list = AppCompatResources.getColorStateList(this.mContext, resourceId);
        if (list == null) {
            return this.mWrapped.getColorStateList(n);
        }
        return list;
        list = this.mWrapped.getColorStateList(n);
        return list;
    }
