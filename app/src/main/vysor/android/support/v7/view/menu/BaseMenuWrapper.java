...
abstract class BaseMenuWrapper<T> extends BaseWrapper<T>
{
    ...
    final MenuItem getMenuItemWrapper(final MenuItem menuItem) {
        ...
        if (menuItem instanceof SupportMenuItem) {
            ...
            wrapSupportMenuItem = this.mMenuItems.get(menuItem);
