...
public class MenuBuilder implements SupportMenu
{
    ...
    public MenuItem findItem(final int n) {
        ...
        int i = 0;
        while (i < size) {
            Object o = this.mItems.get(i);
            if (((MenuItemImpl)o).getItemId() != n) {
                if (((MenuItemImpl)o).hasSubMenu()) {
                    final MenuItem item = ((MenuItemImpl)o).getSubMenu().findItem(n);
                    if (item != null) {
                        o = item;
                        return (MenuItem)o;
                    }
    ...
    MenuItemImpl findItemWithShortcutForKey(final int n, final KeyEvent keyEvent) {
        ...
        final boolean empty = mTempShortcutItemList.isEmpty();
        ...
        if (!empty) {
            ...
            if (size == 1) {
                menuItemImpl = mTempShortcutItemList.get(0);
            }
            else {
                ...
                while (true) {
                    ...
                    menuItemImpl2 = mTempShortcutItemList.get(n2);
                    char c;
                    if (qwertyMode) {
