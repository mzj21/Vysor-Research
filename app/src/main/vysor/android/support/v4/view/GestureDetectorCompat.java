    ...
    static class GestureDetectorCompatImplBase implements GestureDetectorCompatImpl
    {
        ...
        private boolean isConsideredDoubleTap(final MotionEvent motionEvent, final MotionEvent motionEvent2, final MotionEvent motionEvent3) {
            ...
            if (mAlwaysInBiggerTapRegion) {
                final long n = lcmp(motionEvent3.getEventTime() - motionEvent2.getEventTime(), (long)GestureDetectorCompatImplBase.DOUBLE_TAP_TIMEOUT);
                b = false;
                if (n <= 0) {
                    ...
                    final int mDoubleTapSlopSquare = this.mDoubleTapSlopSquare;
                    b = false;
                    if (n4 < mDoubleTapSlopSquare) {
                        b = true;
                    }
                }
            }
                ...
                switch (n6) {
                    ...
                    case 6: {
                        ...
                        while (true) {
                            ...
                            if (n7 != actionIndex2) {
                                final int pointerId2 = motionEvent.getPointerId(n7);
                    ...
                    case 0: {
                        ...
                        if (mDoubleTapListener != null) {
                            ...
                            if (this.mCurrentDownEvent != null && this.mPreviousUpEvent != null && hasMessages && this.isConsideredDoubleTap(this.mCurrentDownEvent, this.mPreviousUpEvent, motionEvent)) {
                                ...
                                b3 = (false | this.mDoubleTapListener.onDoubleTap(this.mCurrentDownEvent) | this.mDoubleTapListener.onDoubleTapEvent(motionEvent));
                            }
                            else {
                        ...
                        b2 = (b3 | this.mListener.onDown(motionEvent));
                        break;
                    }
                    case 2: {
                        ...
                        if (this.mIsDoubleTapping) {
                            b2 = (false | this.mDoubleTapListener.onDoubleTapEvent(motionEvent));
                            break;
                        }
                        if (!this.mAlwaysInTapRegion) {
                            ...
                            b2 = this.mListener.onScroll(this.mCurrentDownEvent, motionEvent, n9, n10);
                            this.mLastFocusX = n4;
                            this.mLastFocusY = n5;
                            break;
                        }
                    ...
                    case 1: {
                        ...
                        Label_0959: {
                            if (this.mIsDoubleTapping) {
                                ...
                                b2 = this.mListener.onSingleTapUp(motionEvent);
                                ...
                                b2 = this.mListener.onFling(this.mCurrentDownEvent, motionEvent, xVelocity2, yVelocity2);
                            }
                        }
