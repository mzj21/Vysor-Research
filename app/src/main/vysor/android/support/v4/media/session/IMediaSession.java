            ...
            switch (n) {
                ...
                case 8: {
                    ...
                    if (launchPendingIntent != null) {
                        ...
                        launchPendingIntent.writeToParcel(parcel2, onTransact);
                        break;
                    }
                    parcel2.writeInt(0);
                    break;
                ...
                case 10: {
                    ...
                    if (volumeAttributes != null) {
                        parcel2.writeInt(onTransact);
                        volumeAttributes.writeToParcel(parcel2, onTransact);
                        break;
                    }
                    parcel2.writeInt(0);
                    break;
                ...
                case 27: {
                    ...
                    if (metadata != null) {
                        parcel2.writeInt(onTransact);
                        metadata.writeToParcel(parcel2, onTransact);
                        break;
                    }
                    parcel2.writeInt(0);
                    break;
                ...
                case 28: {
                    ...
                    if (playbackState != null) {
                        parcel2.writeInt(onTransact);
                        playbackState.writeToParcel(parcel2, onTransact);
                        break;
                    }
                    parcel2.writeInt(0);
                    break;
                ...
                case 30: {
                    ...
                    if (queueTitle != null) {
                        parcel2.writeInt(onTransact);
                        TextUtils.writeToParcel(queueTitle, parcel2, onTransact);
                        break;
                    }
                    parcel2.writeInt(0);
                    break;
