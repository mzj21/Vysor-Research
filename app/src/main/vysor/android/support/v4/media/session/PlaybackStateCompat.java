...
public final class PlaybackStateCompat implements Parcelable
{
    ...
    PlaybackStateCompat(final int mState, final long mPosition, final long mBufferedPosition, final float mSpeed, final long mActions, final CharSequence mErrorMessage, final long mUpdateTime, final List<CustomAction> list, final long mActiveItemId, final Bundle mExtras) {
        this.mState = mState;
    ...
    public static final class CustomAction implements Parcelable
    {
        ...
        public static CustomAction fromCustomAction(final Object mCustomActionObj) {
            ...
            if (mCustomActionObj == null || Build$VERSION.SDK_INT < 21) {
                ...
                customAction = new CustomAction(PlaybackStateCompatApi21.CustomAction.getAction(mCustomActionObj), PlaybackStateCompatApi21.CustomAction.getName(mCustomActionObj), PlaybackStateCompatApi21.CustomAction.getIcon(mCustomActionObj), PlaybackStateCompatApi21.CustomAction.getExtras(mCustomActionObj));
