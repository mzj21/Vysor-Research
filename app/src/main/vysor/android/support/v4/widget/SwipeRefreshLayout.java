...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingChild, NestedScrollingParent
{
    ...
    public boolean canChildScrollUp() {
        ...
        if (this.mChildScrollUpCallback != null) {
            b = this.mChildScrollUpCallback.canChildScrollUp(this, this.mTarget);
        }
            ...
            b = ViewCompat.canScrollVertically(this.mTarget, -1);
        }
        return b;
    }
    ...
    protected int getChildDrawingOrder(final int n, int mCircleViewIndex) {
        if (this.mCircleViewIndex >= 0) {
            if (mCircleViewIndex == n - 1) {
                mCircleViewIndex = this.mCircleViewIndex;
            }
            else if (mCircleViewIndex >= this.mCircleViewIndex) {
                ++mCircleViewIndex;
            }
        }
        ...
        if (enabled) {
            ...
            if (!mReturningToStart) {
                ...
                if (!canChildScrollUp) {
                    ...
                    mIsBeingDragged = false;
                    if (!mRefreshing) {
                        final boolean mNestedScrollInProgress = this.mNestedScrollInProgress;
                        mIsBeingDragged = false;
                        ...
                        if (!mNestedScrollInProgress) {
                            ...
                            switch (actionMasked) {
                                ...
                                case 2: {
                                    ...
                                    final float n = 0.5f * (y - this.mInitialMotionY);
                                ...
                                case 1: {
                                    ...
                                    if (this.mIsBeingDragged) {
                                        final float n3 = 0.5f * (motionEvent.getY(pointerIndex2) - this.mInitialMotionY);
                                        this.mIsBeingDragged = false;
