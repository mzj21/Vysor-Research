...
public interface INotificationSideChannel extends IInterface
{
    ...
    public abstract static class Stub extends Binder implements INotificationSideChannel
    {
        ...
        public static INotificationSideChannel asInterface(final IBinder binder) {
            INotificationSideChannel notificationSideChannel;
            if (binder == null) {
                notificationSideChannel = null;
            }
            else {
                ...
                if (queryLocalInterface != null && queryLocalInterface instanceof INotificationSideChannel) {
                    notificationSideChannel = (INotificationSideChannel)queryLocalInterface;
                }
                else {
                    notificationSideChannel = new Proxy(binder);
                }
            }
            return notificationSideChannel;
        }
