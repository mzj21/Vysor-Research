...
class LoaderManagerImpl extends LoaderManager
{
    ...
    public <D> Loader<D> getLoader(final int n) {
        ...
        if (loaderInfo != null) {
            if (loaderInfo.mPendingLoader != null) {
                o = loaderInfo.mPendingLoader.mLoader;
            }
            else {
                o = loaderInfo.mLoader;
            }
        }
        else {
            o = null;
    ...
    public <D> Loader<D> restartLoader(final int n, final Bundle bundle, final LoaderCallbacks<D> loaderCallbacks) {
            ...
            if (loaderInfo2 != null) {
                if (loaderInfo.mHaveData) {
                    ...
                    if (loaderInfo.cancel()) {
                        ...
                        final Loader<Object> loader = loaderInfo.mPendingLoader.mLoader;
        ...
        final Loader<Object> loader = this.createAndInstallLoader(n, bundle, (LoaderCallbacks<Object>)loaderCallbacks).mLoader;
        return (Loader<D>)loader;
    }
    ...
    final class LoaderInfo implements OnLoadCanceledListener<Object>, OnLoadCompleteListener<Object>
    {
        ...
        void callOnLoadFinished(final Loader<Object> loader, final Object o) {
            ...
            final FragmentHostCallback mHost = LoaderManagerImpl.this.mHost;
        ...
        boolean cancel() {
            ...
            if (this.mStarted && this.mLoader != null && this.mListenerRegistered) {
                cancelLoad = this.mLoader.cancelLoad();
                if (!cancelLoad) {
