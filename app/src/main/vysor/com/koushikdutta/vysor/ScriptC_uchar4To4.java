...
public class ScriptC_uchar4To4 extends ScriptC
{
    private static final String __rs_resource_name = "uchar4to4";
    ...
    public ScriptC_uchar4To4(final RenderScript renderScript) {
        this(renderScript, renderScript.getApplicationContext().getResources(), renderScript.getApplicationContext().getResources().getIdentifier("uchar4to4", "raw", renderScript.getApplicationContext().getPackageName()));
    }
    
    public ScriptC_uchar4To4(final RenderScript renderScript, final Resources resources, final int n) {
