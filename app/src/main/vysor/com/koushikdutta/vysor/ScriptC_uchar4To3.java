...
public class ScriptC_uchar4To3 extends ScriptC
{
    private static final String __rs_resource_name = "uchar4to3";
    ...
    public ScriptC_uchar4To3(final RenderScript renderScript) {
        this(renderScript, renderScript.getApplicationContext().getResources(), renderScript.getApplicationContext().getResources().getIdentifier("uchar4to3", "raw", renderScript.getApplicationContext().getPackageName()));
    }
    
    public ScriptC_uchar4To3(final RenderScript renderScript, final Resources resources, final int n) {
    ...
    public void forEach_root(final Allocation allocation, final Allocation allocation2) {
        ...
        if (!allocation2.getType().getElement().isCompatible(this.__U8_3)) {
